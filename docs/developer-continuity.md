...
* The initial Betting member picker is intentionally compact: two columns on mobile and five columns on large screens, separate from the full betting form card layout.
